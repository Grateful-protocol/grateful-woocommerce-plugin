...
class Setup {
	...
	public function register_scripts() {
		...
		wp_enqueue_script( 'grateful-payments' );
		wp_enqueue_style( 'grateful-payments' );
	}
	...
	public function register_page() {
		...
		wc_admin_register_page(
			array(
				'id'     => 'grateful_payments-example-page',
				'title'  => __( 'Grateful Payments', 'grateful_payments' ),
				'parent' => 'woocommerce',
